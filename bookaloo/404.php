            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    ...
                    <div class="title m thank-you t-center">
                        ...
                        <h1 class="h2 t-white animate slide-in-top">404 Error</h1>
                        <h2 class="h3 sm t-white animate slide-in-top">We can’t seem to find the page you’re looking for.</h2>
                        <p class="t-white lg animate slide-in-top">You may have mis-typed the URL, please double check, or use the menu to navigate to where you need to be.</p>
                    </div>
