...
require 'PHPMailer/SMTP.php';
  ...
  $subject = 'Form Completion - pre payment info';
  ...
  $message .= "<tr style='background: #eee;'><td><strong>Total price with VAT :</strong> </td><td>" . strip_tags($_POST['totalPriceWithVAT']) . "</td></tr>";
  $message .= "<tr style='background: #eee;'><td><strong>Total Price With Disabled With VAT:</strong> </td><td>" . strip_tags($_POST['totalPriceWithDisabledWithVAT']) . "</td></tr>";
  $message .= "<tr style='background: #eee;'><td><strong>Total Price Uber Lux With VAT:</strong> </td><td>" . strip_tags($_POST['totalPriceUberLuxWithVAT']) . "</td></tr>";
  $message .= "<tr style='background: #eee;'><td><strong>Total Price With Disabled Uber Lux With VAT:</strong> </td><td>" . strip_tags($_POST['totalPriceWithDisabledUberLuxWithVAT']) . "</td></tr>";
  $message .= "<tr style='background: #eee;'><td><strong>Disabled Cost:</strong> </td><td>" . strip_tags($_POST['disabledCost']) . "</td></tr>";
