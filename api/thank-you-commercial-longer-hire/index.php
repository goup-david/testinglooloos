            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    ...
                    <div class="title m thank-you t-center">
                        ...
                        <img src="//looloos.co/img/illustration/longer-01.svg" width="220" class="animate slide-in-top" style="margin-bottom:1.5em;">
                        <!-- <img src="/img/illustration/longer-01.svg" width="220" class="animate slide-in-top" style="margin-bottom:1.5em;"> -->
                        <h1 class="h2 t-white animate slide-in-top">Thanks, your enquiry was <br/>successfully submitted.</h1>
                        <h2 class="h3 sm t-white animate slide-in-top">We know that the toilet requirements for longer events can be a bit more complex.</h2>
