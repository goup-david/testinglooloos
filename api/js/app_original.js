...
$(function(){
    ...
    $(document).on("click", "form.book .step-3 .next", function(e) {
        ...
        if (validateStep3() == true) {
              ...
              interval = setInterval(function(){
                ...
                if(percent==100){
                  ...
                  $('.loading-icon').delay(1000).fadeOut(400, function() {
                    ...
                    if ($('input[name=form-event]:checked').val() == 'Construction') {
                      $(location).attr('href','https://looloos.co/thank-you-commercial-hire');
          ...
          // No of Men
          var noMen = $("[name='form-men-number']").val();
          $('.4-no-men').html(noMen);

          // No of Women
          var noWomen = $("[name='form-men-number']").val();
            ...
            */
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data === 'Success') window.location = "//looloos.co/thank-you/";
